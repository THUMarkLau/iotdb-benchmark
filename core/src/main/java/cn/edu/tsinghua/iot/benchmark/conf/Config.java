...
public class Config {
  ...
  public boolean isUseNewRecordsColumnFormat() {
    return useNewRecordsColumnFormat;
  }

  public void setUseNewRecordsColumnFormat(boolean useNewRecordsColumnFormat) {
    this.useNewRecordsColumnFormat = useNewRecordsColumnFormat;
  }

  public boolean isUseValueCompressionInNewRPC() {
    return useValueCompressionInNewRPC;
  }

  public void setUseValueCompressionInNewRPC(boolean useValueCompressionInNewRPC) {
    this.useValueCompressionInNewRPC = useValueCompressionInNewRPC;
  }

  public boolean isUseTimeCompressionInNewRPC() {
    return useTimeCompressionInNewRPC;
  }

  public void setUseTimeCompressionInNewRPC(boolean useTimeCompressionInNewRPC) {
    this.useTimeCompressionInNewRPC = useTimeCompressionInNewRPC;
  }
